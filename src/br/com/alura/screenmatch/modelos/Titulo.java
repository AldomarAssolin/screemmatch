...
public class Titulo implements Comparable<Titulo> {
    ...
    public Titulo(TituloOMDB meuTituloOmdb) {
        ...
        if(meuTituloOmdb.year().length() > 4){
            throw new ErrorDeCoversaoDeAnoException("Não foi possível converter o ano, pois possue mais de 4 caractere");
        }
    ...
    public String toString() {
        return STR."Nome: '\{nome}\{'\''}, AnoDeLancamento: \{anoDeLancamento}, Duração = \{duracaoEmMinutos}min";
    }
